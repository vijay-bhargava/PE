...
import { formatDateViaLocale, getBIDSavingSummaryReport, getBIDSummaryDetailedReport, getBIDSummaryReport, getReportColumns, getRFQSummaryReport } from '../../utils/common/utility';
...
const BIDSavingSummaryReport = () => {
    ...
    const LOCAL_STORAGE_KEY = 'BISavingSummaryReportColumnVisibility';
    useEffect(() => {
...
const pullBIDSummaryReport = async (pageNumber = 1, pageSize = 10, filterData = null) => {
    ...
    try {
        ...
        const res = await apiClient.get(
            `api/AuctionManage/BIdSavingSummaryReport?${queryParams}`,
            atoken
        );
    ...
    >
      <div className="d-flex justify-content-between border-bottom align-items-center mb-3 mt-2">
        <div className="page-heading text-dark-blue textMedium">
          <BackButton title="BID Saving Summary Report" />
        </div>
      </div>
      {activeFiltersCount > 0 && (
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 mb-3">
                                        <FormControl fullWidth>
                                            ...
                                            >
                                                {["Open", "Draft", "Under Pre Approval", "Technical Approval", "Commercial Approval", "Awarded", "Forwarded", "Cancel", "Close"].map((s) => (
