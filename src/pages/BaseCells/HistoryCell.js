  ...
  return (
    ...
    <>
      ...
      {state.technicalApprovalDrawer && ReactDOM.createPortal(
        <div className="rfq-v2-event-drawer-backdrop" onClick={toggleDrawer('technicalApprovalDrawer', false)} style={{ zIndex: 1500 }}>
          <section className="rfq-v2-event-drawer" style={{ zIndex: 1501 }} onClick={e => e.stopPropagation()}>
                ...
                return (
                  <>
                    <header className="rfq-v2-event-drawer-header">
                      <h2 className="rfq-v2-event-drawer-title">Audit History</h2>
                      <div className="rfq-v2-event-drawer-actions">
                        <button type="button" className="rfq-v2-event-btn rfq-v2-event-btn-muted" onClick={toggleDrawer('technicalApprovalDrawer', false)}>Close</button>
                      </div>
                    </header>
                    <div className="rfq-v2-event-drawer-body" style={{ padding: 16 }}>
              ...
              return (
                <>
                  <header className="rfq-v2-event-drawer-header">
                    <h2 className="rfq-v2-event-drawer-title">Audit History</h2>
                    <div className="rfq-v2-event-drawer-actions">
                      <button type="button" className="pe-btn pe-btn--ghost" onClick={toggleDrawer('technicalApprovalDrawer', false)}>Close</button>
                    </div>
                  </header>
                  <div className="rfq-v2-event-drawer-body" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column', gap: 0, padding: 0 }}>
