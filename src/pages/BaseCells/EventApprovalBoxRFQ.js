                    ...
                    <Card.Body className="p-0 m-0">
                        <div className="">
                            ...
                            <React.Fragment key="eventapprovalboxrfq">
                                <Accordion className="shadow-none mt-2 mb-2 approvalAcordion" key="eventapprovalboxrfq" defaultExpanded >
                                                        ...
                                                        <div className="text-end mb-2 ps-5 pe-1">
                                                            <div>
                                                                <span className="d-flex align-items-baseline">
                                                                    ...
                                                                    {accessLevel?.find(x => x.claimType == "Work Flow")?.claimValue?.Create != "N" && <IconButton
                                                                        size="small"
