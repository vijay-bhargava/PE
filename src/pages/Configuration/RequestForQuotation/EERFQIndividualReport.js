...
import {
	Tabs, Tab, Paper, Typography, Button,
	Collapse, Tooltip, Menu, MenuItem, IconButton,
	Box, Drawer, TextField, InputAdornment
} from '@mui/material';
...
const EERFQIndividualReport = ({ accessLevel }) => {
	...
	const [{ atoken, rtoken, customerid, customersuffix, roleClaims, userDetail }, dispatch, thousands_separators] = useStateValue();
