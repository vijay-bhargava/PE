...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TablePagination, Paper, Typography, Button, Collapse, Tooltip, Menu, MenuItem, IconButton, Box, Drawer, TextField, InputAdornment } from '@mui/material';
...
const DetailsReport = () => {
  ...
  const [{ atoken, customerid, customersuffix, userDetail }, thousands_separators] =
    useStateValue();
  ...
  return (
    <div>
      ...
      <div className='custom-fix'>
            ...
            <Card.Body>
              <div className='row mx-1'>
                ...
                <div className='col-md-3 ms-0 ps-0'>
                  ...
                  <div className='f12 fw400'>
                    <CommonTooltip title={supplierdetails?.remarks || ''} placement="bottom">
                      <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', display: 'block' }}>{supplierdetails?.remarks ?? "N/A"}</span>
                    </CommonTooltip>
                  </div>
                </div>
                    ...
                    return (
                      <React.Fragment key={row.id}>
                        ...
                        <TableRow className={index % 2 === 0 ? "striped-row" : ""}>
                          ...
                          <TableCell className='pointer' align="left">
                            <CommonTooltip title={row?.itemDesc || ''} placement="bottom">
                              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', display: 'block', maxWidth: 150 }}>{row?.itemDesc}</span>
                            </CommonTooltip>
                          </TableCell>
                          <TableCell className='pointer'>
                            <CommonTooltip title={row?.remarks || ''} placement="bottom">
                              <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', display: 'block', maxWidth: 150 }}>{row?.remarks}</span>
                            </CommonTooltip>
                          </TableCell>
                              ...
                              <div className="expanded-row-content">
                                ...
                                <Table size="small">
                                  <TableBody>
                                    ...
                                    {rfqheader?.rfqItemCommercial.filter(x => x.level === "item").map((x, i) => {
        ...
        {rfqheader?.rfqPackageCommercial.filter(x => x.level != "item") && rfqheader?.rfqPackageCommercial.filter(x => x.level != "item").length > 0 && <Paper className="t mx-1 rounded mt-2">
          <TableContainer className='itemstable'>
            <Table stickyHeader>
              <TableHead className="table-header">
                <TableRow>
              ...
              <TableBody>
                {rfqheader?.rfqPackageCommercial.filter(x => x.level != "item")?.map((row, index) => {
          ...
          <div className="table-pagination">
            <TablePagination
              rowsPerPageOptions={[5, 10, 25]}
              component="div"
              count={rfqheader?.rfqPackageCommercial?.filter(x => x.level != "item")?.length}
              rowsPerPage={rowsPerPage}
              page={page}
              onPageChange={handleChangePage}
              onRowsPerPageChange={handleChangeRowsPerPage}
