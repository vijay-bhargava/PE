...
import {
    Autocomplete, Alert, Button, ButtonGroup, Checkbox, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, FormControl, FormControlLabel, FormHelperText, FormLabel, InputAdornment, InputLabel, Menu, MenuItem, Radio, RadioGroup, Select, Stack, TextField, Tooltip, Typography, Badge, createFilterOptions, Card,
    CardHeader,
    CardContent,
} from "@mui/material";
...
import { checkUTC, cleanAndConvertToArray, extractTextFromHTML, getAuctionItemServiceFind, getAuctionManageFind, getCurrency, getDateFormatPatteronLocale, getLibraryOrgEntityFind, getPurchaseOrgList, scrollToTargetC, userampm } from "../../../utils/common/utility";
...
const Auctions = ({ claimType }) => {
    ...
    //console.log("commercialLibFind::", commercialLibFind)
    const [idFromURL, setIdFromURL] = useState(null);
    //console.log("idFromURL in Auctions:", idFromURL);
    ...
    //console.log("tempDataEditData::", tempDataEditData)
        ...
        <>
            <div className="mainContainer d-flex" style={{ gap: '1rem' }}>
                <div className={`leftContent ${approvershow ? "col-9" : "col-12"} d-flex flex-column`}>
                    <div className="bg-white rounded-default shadow-sm p-3 w-100 flex-grow-1 d-flex flex-column" style={{
                        ...
                        <div className="flex-grow-1 p-1 hidden-scrollbar" style={{
