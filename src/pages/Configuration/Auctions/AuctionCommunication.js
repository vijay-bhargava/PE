...
import { InputAdornment, TextField, Button, IconButton, Alert } from '@mui/material';
    ...
    return (
        <>
            {!(permissionManager?.hasPermission(CLAIM_TYPES.QUERIES, ACTIONS.READ) ?? false) ? (
                ...
                <div className="auction-app-container">
                    <div className={`auction-sidebar mt-2 ${isOverlay ? 'hidden' : ''}`}>
                        <div style={{ display: "flex" }}>
                            <IconButton className='col-md-2' onClick={() => handleApprover(false)}>
                                <IoMdArrowRoundBack />
                            </IconButton>
                            <div className='sidebar-search mt-2 mb-3 col-md-9'>
                                <TextField
                    ...
                    <div className={`auction-main-content ps-0 pb-0 pe-0 ${isOverlay ? 'overlay' : 'hidden'}`}>
                        {isOverlay && (
                            <div className='d-flex align-items-center justify-content-between sidebar-search'>
