...
import GridSkeleton from "../../../components/Skeleton/gridSkeleton";
 ...
 const [rowCell, setRowCell] = useState(null);
            ...
            <div className="col-12 col-md-8 col-lg-12 p-0 ">
              <div className="d-flex flex-column min-vh-100">
                <div className="d-flex justify-content-between minh50px align-items-center bg-white p-2 border-bottom">
                  <BackButton title="Question Library"/>
  ...
  <div className="p-3">
                      ...
                      return (
                        <React.Fragment key={index}>
                          <tr className={index % 2 === 0 ? 'even' : 'odd'}>
                             <td className="f14 productTd" style={{ cursor: "pointer" }}>{item?.eventType}</td>
        ...
        >
          <Modal.Header className="bgheaderCards p-2">
            <Modal.Title id="modal-heading">
              <div className="d-flex align-items-center f14  fw500 text-white">ADD OPTIONS</div>
            </Modal.Title>
            <IconButton
   ...
   export default ShowQuestionLibarary;
