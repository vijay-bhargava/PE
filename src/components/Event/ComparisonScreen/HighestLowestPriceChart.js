      ...
      <CardContent sx={{ padding: '12px !important', paddingBottom: '12px !important' }}>
        ...
        <div className={styles.chartContainer} style={{ overflowX: 'auto' }}>
          <svg width={chartWidth} height={250} style={{ minWidth: '300px' }}>
            ...
            {/* Legend */}
            <g>
              <rect x="60" y="5" width="10" height="10" fill="#f44336"/>
              <text x="75" y="14" fontSize="10" fill="#666">Highest Price</text>
              <rect x="160" y="5" width="10" height="10" fill="#4caf50"/>
              <text x="175" y="14" fontSize="10" fill="#666">Lowest Price</text>
            </g>
