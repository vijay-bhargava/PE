...
const EventApprovalWorkFlow = ({ approverlist, pushDeleteEventApprover, action, accessLevel, permissionManager, stagelist, eventCode, eventSubject, startDate, endDate, variant }) => {
